(function () {
  const MANAGED_PRODUCTS_KEY = "novaMarketDemoManagedProducts";
  const CUSTOM_PRODUCTS_KEY = "novaMarketDemoCustomProducts";
  const CART_KEY = "novaMarketDemoCart";
  const WISHLIST_KEY = "novaMarketDemoWishlist";
  const ORDERS_KEY = "novaMarketDemoOrders";
