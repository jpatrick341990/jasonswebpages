(function(){
  const STORAGE_KEY = 'novaBrandSettingsDemoV1';
  const copyDefaults = {
    copyNavHome: 'Home',
    copyNavShop: 'Shop',
    ...
    copyHeaderCart: 'Cart',
    copyFooterOwnerButton: 'Owner Settings',
    copyHeroEyebrow: 'New Season • Better Living',
    copyHeroTitle: 'Upgrade Your Everyday Essentials',
    copyHeroBody: 'Discover premium pieces for home, style, travel, and tech. This storefront is built to look polished on day one and stay easy to manage after launch.',
    ...
    copyPromoKicker: 'Spring Edit',
    copyPromoTitle: 'Fresh Finds Up to 40% Off',
    ...
    copyCategoriesTitle: 'Shop by the styles you love most',
    ...
    copyBestTitle: 'Customer favorites shoppers keep coming back for',
    copyBrandsKicker: 'Featured Brands',
    copyBrandsTitle: 'Brands shoppers recognize and trust',
    copySellerKicker: 'Limited-Time Offer',
    copySellerTitle: 'Weekend Deals',
    ...
    copyReviewsTitle: 'What shoppers are saying',
    copyJournalKicker: 'From the Journal',
    copyJournalTitle: 'Shopping inspiration, product tips, and store updates',
    copyFeaturedKicker: 'Featured Picks',
    copyFeaturedTitle: 'New arrivals just added to the store',
    copyNewsletterKicker: 'Join The List',
    copyNewsletterTitle: 'Get first access to new drops, fresh collections, and exclusive deals',
    ...
    copyFooterWhyText: 'Modern design, trusted checkout, premium products, and a cleaner shopping experience from top to bottom.',
    copyGlobalReplacements: ''
  };
  const defaults = {
    storeName: 'Nova Market',
    tagLine: 'Premium Lifestyle Store',
    announcement: 'Free Shipping On Orders Over $50 • New Spring Collection Just Dropped • Limited-Time Deals Live Now',
    utility: 'Free Shipping | Secure Checkout | 30-Day Returns',
    footerNote: 'A polished multi-page storefront with a built-in seller dashboard, customer account area, and premium product editing flow.',
    supportEmail: 'support@novamarket.example',
  ...
  function exportSettings(){
    ...
    link.download = 'nova-market-demo-brand-settings.json';
    link.click();
